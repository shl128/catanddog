...
//    })
//    public ResponseEntity<? extends BaseResponseBody> save(Pet pet, @ApiIgnore Authentication authentication){
//
//        if(petService.savePet(pet) != null){
...
//        List<Pet> petInfoList = petService.findPet(user.getUserId());
//        if(petInfoList != null){
...
//            @ApiResponse(code = 500, message = "서버 오류")
//    })
//    public ResponseEntity<? extends BaseResponseBody> update(@ApiIgnore Authentication authentication, @PathVariable("pet_id")Long petId, Pet pet){
//        pet.setPetId(petId);
//        if(petService.update(pet) != null){
//            return ResponseEntity.status(200).body(BaseResponseBody.of(200, "Success"));
//        }
//        return ResponseEntity.status(500).body(BaseResponseBody.of(500, "Error"));
//    }
